...
import { fecthDetailQuery, fetchQuery, searchQuery } from "./utils/supports";
...
export const deleteUploadAsset = async (id) => {
...
export const addToComments = async (id, uid, comment) => {
  ...
  await client.create(doc).then((com) => {
    client
      ...
      .commit()
      .then((res) => console.log("new comments: ", res));
  });
};
